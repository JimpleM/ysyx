...
module mem_1024x64(	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  ...
  //   W0_en_t <= W0_en;
  //   if(W0_en_t)begin
  //     $display("addr = %x wdata = %x data = %x mask = %x\n",W0_addr,W0_data,Memory[W0_addr],W0_mask);
  //   end
  // end
...
module APBSDRAM(	// src/device/SDRAM.scala:92:9
  ...
  output [1:0]  sdram_bundle_ba,	// src/device/SDRAM.scala:94:26
                sdram_bundle_dqm,	// src/device/SDRAM.scala:94:26
  inout  [15:0] sdram_bundle_dq	// src/device/SDRAM.scala:94:26
);
