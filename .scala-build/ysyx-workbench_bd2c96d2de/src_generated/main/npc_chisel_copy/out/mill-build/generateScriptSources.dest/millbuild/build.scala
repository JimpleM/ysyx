...
package npc_chisel_copy.out.mill$minusbuild.generateScriptSources$u002Edest.millbuild



final class build$_ {
def args = build_sc.args$
def scriptPath = """npc_chisel_copy/out/mill-build/generateScriptSources.dest/millbuild/build.sc"""
/*<script>*/
package millbuild
