...
VL_INLINE_OPT void Vriscv32___024root___ico_comb__TOP__0(Vriscv32___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv32__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vriscv32___024root___ico_comb__TOP__0\n"); );
    // Body
    ...
    vlSelf->riscv32__DOT__riscv_bpu_u0__DOT__npc = 
        ((((0x63U == (0x7fU & vlSelf->riscv32__DOT__ifu_inst)) 
          ...
          ? (vlSelf->riscv32__DOT__ifu_pc + vlSelf->riscv32__DOT__idu_imm)
          : ((0x67U == (0x7fU & vlSelf->riscv32__DOT__ifu_inst))
              ? (vlSelf->riscv32__DOT__src1 + vlSelf->riscv32__DOT__idu_imm)
