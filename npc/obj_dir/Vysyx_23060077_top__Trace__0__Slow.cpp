...
VL_ATTR_COLD void Vysyx_23060077_top___024root__trace_init_sub__TOP__0(Vysyx_23060077_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+434,"ifu_inst_t", false,-1, 31,0);
    ...
    tracep->declBus(c+432,"rd_data", false,-1, 31,0);
    tracep->declBit(c+114,"zero_flag", false,-1);
    tracep->declBus(c+115,"exu_result", false,-1, 31,0);
    tracep->declBus(c+435,"exu_result_t", false,-1, 31,0);
    ...
    tracep->declBit(c+436,"carry_flag", false,-1);
    tracep->declBit(c+437,"signed_flag", false,-1);
    ...
    tracep->declBus(c+440,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+459,"default_out", false,-1, 1,0);
    tracep->declArray(c+460,"lut", false,-1, 98,0);
    tracep->pushNamePrefix("i1 ");
    tracep->declBus(c+438,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+458,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+447,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+467,"lut", false,-1, 26,0);
    tracep->pushNamePrefix("i1 ");
    tracep->declBus(c+465,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+458,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+447,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBit(c+430,"aclk", false,-1);
    tracep->declBit(c+431,"areset_n", false,-1);
    tracep->declBit(c+96,"cpu_r_valid_i", false,-1);
    tracep->declBus(c+309,"cpu_r_addr_i", false,-1, 31,0);
    tracep->declBit(c+311,"cpu_r_ready_o", false,-1);
    tracep->declBus(c+310,"cpu_r_data_o", false,-1, 31,0);
    tracep->declBit(c+472,"cpu_w_valid_i", false,-1);
    tracep->declBus(c+473,"cpu_w_addr_i", false,-1, 31,0);
    tracep->declBit(c+312,"cpu_w_ready_o", false,-1);
    tracep->declBus(c+474,"cpu_w_data_i", false,-1, 31,0);
    tracep->declBus(c+475,"cpu_w_strb_i", false,-1, 2,0);
    tracep->declBit(c+313,"axi_aw_ready_i", false,-1);
    tracep->declBit(c+314,"axi_aw_valid_o", false,-1);
    tracep->declBus(c+476,"axi_aw_port_o", false,-1, 2,0);
    tracep->declBus(c+473,"axi_aw_addr_o", false,-1, 31,0);
    tracep->declBit(c+315,"axi_w_ready_i", false,-1);
    tracep->declBit(c+316,"axi_w_valid_o", false,-1);
    tracep->declBus(c+475,"axi_w_strb_o", false,-1, 2,0);
    tracep->declBus(c+474,"axi_w_data_o", false,-1, 31,0);
    tracep->declBus(c+477,"axi_b_resp_i", false,-1, 2,0);
    ...
    tracep->declBus(c+476,"axi_ar_port_o", false,-1, 2,0);
    ...
    tracep->declBus(c+478,"axi_r_resp_i", false,-1, 2,0);
    ...
    tracep->declBus(c+478,"axi_r_resp_i", false,-1, 2,0);
    tracep->declBus(c+310,"axi_r_data_i", false,-1, 31,0);
    tracep->declBus(c+321,"lfsr_out", false,-1, 5,0);
    tracep->declBus(c+322,"r_delay_cnt", false,-1, 5,0);
    tracep->declBus(c+323,"w_delay_cnt", false,-1, 5,0);
    tracep->declBus(c+324,"axi_w_state", false,-1, 2,0);
    tracep->declBus(c+325,"axi_w_state_nxt", false,-1, 2,0);
    tracep->declBus(c+476,"AXI_W_IDLE", false,-1, 2,0);
    tracep->declBus(c+479,"AXI_W_ADDR", false,-1, 2,0);
    tracep->declBus(c+480,"AXI_W_DATA", false,-1, 2,0);
    tracep->declBus(c+481,"AXI_W_RESP", false,-1, 2,0);
    tracep->declBus(c+482,"AXI_W_DELAY", false,-1, 2,0);
    tracep->declBus(c+326,"axi_r_state", false,-1, 1,0);
    tracep->declBus(c+327,"axi_r_state_nxt", false,-1, 1,0);
    tracep->declBus(c+466,"AXI_R_IDLE", false,-1, 1,0);
    tracep->declBus(c+459,"AXI_R_ADDR", false,-1, 1,0);
    tracep->declBus(c+483,"AXI_R_DATA", false,-1, 1,0);
    tracep->declBus(c+484,"AXI_R_DELAY", false,-1, 1,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+476,"axi_aw_port_i", false,-1, 2,0);
    tracep->declBus(c+473,"axi_aw_addr_i", false,-1, 31,0);
    tracep->declBit(c+315,"axi_w_ready_o", false,-1);
    tracep->declBit(c+316,"axi_w_valid_i", false,-1);
    tracep->declBus(c+475,"axi_w_strb_i", false,-1, 2,0);
    tracep->declBus(c+474,"axi_w_data_i", false,-1, 31,0);
    tracep->declBus(c+477,"axi_b_resp_o", false,-1, 2,0);
    ...
    tracep->declBus(c+476,"axi_ar_port_i", false,-1, 2,0);
    ...
    tracep->declBus(c+478,"axi_r_resp_o", false,-1, 2,0);
    tracep->declBus(c+310,"axi_r_data_o", false,-1, 31,0);
    tracep->declBus(c+328,"lfsr_out", false,-1, 5,0);
    tracep->declBus(c+329,"r_delay_cnt", false,-1, 5,0);
    tracep->declBus(c+330,"w_delay_cnt", false,-1, 5,0);
    tracep->declBus(c+331,"sram_w_state", false,-1, 2,0);
    tracep->declBus(c+476,"SRAM_W_IDLE", false,-1, 2,0);
    tracep->declBus(c+479,"SRAM_W_ADDR", false,-1, 2,0);
    tracep->declBus(c+480,"SRAM_W_DATA", false,-1, 2,0);
    tracep->declBus(c+481,"SRAM_W_RESP", false,-1, 2,0);
    tracep->declBus(c+332,"w_addr", false,-1, 31,0);
    tracep->declBus(c+333,"w_data", false,-1, 31,0);
    tracep->declBus(c+334,"w_mask", false,-1, 31,0);
    ...
    tracep->declBus(c+335,"sram_r_state", false,-1, 1,0);
    tracep->declBus(c+466,"SRAM_R_IDLE", false,-1, 1,0);
    tracep->declBus(c+459,"SRAM_R_ADDR", false,-1, 1,0);
    tracep->declBus(c+483,"SRAM_R_DATA", false,-1, 1,0);
    tracep->declBus(c+336,"r_addr", false,-1, 31,0);
    tracep->declBus(c+337,"r_data", false,-1, 31,0);
    ...
    tracep->declBit(c+117,"lsu_rd_wen", false,-1);
    tracep->declBus(c+116,"lsu_result", false,-1, 31,0);
    tracep->declBus(c+338,"raddr", false,-1, 31,0);
    tracep->declBus(c+339,"rdata", false,-1, 31,0);
    tracep->declBus(c+338,"waddr", false,-1, 31,0);
    tracep->declBus(c+113,"wdata", false,-1, 31,0);
    tracep->declBus(c+340,"wmask", false,-1, 31,0);
    tracep->declBus(c+340,"mask", false,-1, 31,0);
    tracep->declBit(c+341,"ren", false,-1);
    tracep->declBit(c+342,"wen", false,-1);
    tracep->declBit(c+343,"lsu_rd_wen_r", false,-1);
    tracep->declBit(c+344,"lsu_rd_wen_w", false,-1);
    ...
    tracep->declBus(c+345,"key", false,-1, 4,0);
    tracep->declBus(c+441,"default_out", false,-1, 31,0);
    tracep->declArray(c+488,"lut", false,-1, 110,0);
    tracep->pushNamePrefix("i1 ");
    tracep->declBus(c+465,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+485,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+440,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBit(c+430,"aclk", false,-1);
    tracep->declBit(c+431,"areset_n", false,-1);
    tracep->declBit(c+341,"cpu_r_valid_i", false,-1);
    tracep->declBus(c+338,"cpu_r_addr_i", false,-1, 31,0);
    tracep->declBit(c+343,"cpu_r_ready_o", false,-1);
    tracep->declBus(c+339,"cpu_r_data_o", false,-1, 31,0);
    tracep->declBit(c+342,"cpu_w_valid_i", false,-1);
    tracep->declBus(c+338,"cpu_w_addr_i", false,-1, 31,0);
    tracep->declBit(c+344,"cpu_w_ready_o", false,-1);
    tracep->declBus(c+113,"cpu_w_data_i", false,-1, 31,0);
    tracep->declBus(c+371,"cpu_w_strb_i", false,-1, 2,0);
    tracep->declBit(c+372,"axi_aw_ready_i", false,-1);
    tracep->declBit(c+373,"axi_aw_valid_o", false,-1);
    tracep->declBus(c+476,"axi_aw_port_o", false,-1, 2,0);
    tracep->declBus(c+338,"axi_aw_addr_o", false,-1, 31,0);
    tracep->declBit(c+374,"axi_w_ready_i", false,-1);
    tracep->declBit(c+375,"axi_w_valid_o", false,-1);
    tracep->declBus(c+371,"axi_w_strb_o", false,-1, 2,0);
    tracep->declBus(c+113,"axi_w_data_o", false,-1, 31,0);
    tracep->declBus(c+492,"axi_b_resp_i", false,-1, 2,0);
    tracep->declBit(c+344,"axi_b_valid_i", false,-1);
    tracep->declBit(c+376,"axi_b_ready_o", false,-1);
    tracep->declBit(c+377,"axi_ar_ready_i", false,-1);
    tracep->declBit(c+378,"axi_ar_valid_o", false,-1);
    tracep->declBus(c+476,"axi_ar_port_o", false,-1, 2,0);
    tracep->declBus(c+338,"axi_ar_addr_o", false,-1, 31,0);
    tracep->declBit(c+379,"axi_r_ready_o", false,-1);
    tracep->declBit(c+343,"axi_r_valid_i", false,-1);
    tracep->declBus(c+493,"axi_r_resp_i", false,-1, 2,0);
    tracep->declBus(c+339,"axi_r_data_i", false,-1, 31,0);
    tracep->pushNamePrefix("u_ysyx_23060077_riscv_axi ");
    tracep->declBit(c+430,"aclk", false,-1);
    tracep->declBit(c+431,"areset_n", false,-1);
    tracep->declBit(c+341,"cpu_r_valid_i", false,-1);
    ...
    tracep->declBus(c+493,"axi_r_resp_i", false,-1, 2,0);
    tracep->declBus(c+339,"axi_r_data_i", false,-1, 31,0);
    tracep->declBus(c+380,"lfsr_out", false,-1, 5,0);
    tracep->declBus(c+381,"r_delay_cnt", false,-1, 5,0);
    tracep->declBus(c+382,"w_delay_cnt", false,-1, 5,0);
    tracep->declBus(c+383,"axi_w_state", false,-1, 2,0);
    tracep->declBus(c+384,"axi_w_state_nxt", false,-1, 2,0);
    tracep->declBus(c+476,"AXI_W_IDLE", false,-1, 2,0);
    tracep->declBus(c+479,"AXI_W_ADDR", false,-1, 2,0);
    tracep->declBus(c+480,"AXI_W_DATA", false,-1, 2,0);
    tracep->declBus(c+481,"AXI_W_RESP", false,-1, 2,0);
    tracep->declBus(c+482,"AXI_W_DELAY", false,-1, 2,0);
    tracep->declBus(c+385,"axi_r_state", false,-1, 1,0);
    tracep->declBus(c+386,"axi_r_state_nxt", false,-1, 1,0);
    tracep->declBus(c+466,"AXI_R_IDLE", false,-1, 1,0);
    tracep->declBus(c+459,"AXI_R_ADDR", false,-1, 1,0);
    tracep->declBus(c+483,"AXI_R_DATA", false,-1, 1,0);
    tracep->declBus(c+484,"AXI_R_DELAY", false,-1, 1,0);
    ...
    tracep->declBit(c+430,"aclk", false,-1);
    tracep->declBit(c+431,"areset_n", false,-1);
    tracep->declBit(c+372,"axi_aw_ready_o", false,-1);
    tracep->declBit(c+373,"axi_aw_valid_i", false,-1);
    tracep->declBus(c+476,"axi_aw_port_i", false,-1, 2,0);
    tracep->declBus(c+338,"axi_aw_addr_i", false,-1, 31,0);
    tracep->declBit(c+374,"axi_w_ready_o", false,-1);
    tracep->declBit(c+375,"axi_w_valid_i", false,-1);
    tracep->declBus(c+371,"axi_w_strb_i", false,-1, 2,0);
    tracep->declBus(c+113,"axi_w_data_i", false,-1, 31,0);
    tracep->declBus(c+492,"axi_b_resp_o", false,-1, 2,0);
    tracep->declBit(c+344,"axi_b_valid_o", false,-1);
    tracep->declBit(c+376,"axi_b_ready_i", false,-1);
    tracep->declBit(c+377,"axi_ar_ready_o", false,-1);
    tracep->declBit(c+378,"axi_ar_valid_i", false,-1);
    tracep->declBus(c+476,"axi_ar_port_i", false,-1, 2,0);
    tracep->declBus(c+338,"axi_ar_addr_i", false,-1, 31,0);
    tracep->declBit(c+379,"axi_r_ready_i", false,-1);
    tracep->declBit(c+343,"axi_r_valid_o", false,-1);
    tracep->declBus(c+493,"axi_r_resp_o", false,-1, 2,0);
    tracep->declBus(c+339,"axi_r_data_o", false,-1, 31,0);
    tracep->declBus(c+387,"lfsr_out", false,-1, 5,0);
    tracep->declBus(c+388,"r_delay_cnt", false,-1, 5,0);
    tracep->declBus(c+389,"w_delay_cnt", false,-1, 5,0);
    tracep->declBus(c+390,"sram_w_state", false,-1, 2,0);
    tracep->declBus(c+476,"SRAM_W_IDLE", false,-1, 2,0);
    tracep->declBus(c+479,"SRAM_W_ADDR", false,-1, 2,0);
    tracep->declBus(c+480,"SRAM_W_DATA", false,-1, 2,0);
    tracep->declBus(c+481,"SRAM_W_RESP", false,-1, 2,0);
    tracep->declBus(c+391,"w_addr", false,-1, 31,0);
    tracep->declBus(c+392,"w_data", false,-1, 31,0);
    tracep->declBus(c+393,"w_mask", false,-1, 31,0);
    tracep->declBit(c+372,"axi_aw_ready_o_r", false,-1);
    tracep->declBit(c+374,"axi_w_ready_o_r", false,-1);
    tracep->declBit(c+344,"axi_b_valid_o_r", false,-1);
    tracep->declBus(c+394,"sram_r_state", false,-1, 1,0);
    tracep->declBus(c+466,"SRAM_R_IDLE", false,-1, 1,0);
    tracep->declBus(c+459,"SRAM_R_ADDR", false,-1, 1,0);
    tracep->declBus(c+483,"SRAM_R_DATA", false,-1, 1,0);
    tracep->declBus(c+395,"r_addr", false,-1, 31,0);
    tracep->declBus(c+396,"r_data", false,-1, 31,0);
    tracep->declBit(c+377,"axi_ar_ready_o_r", false,-1);
    tracep->declBit(c+343,"axi_r_valid_o_r", false,-1);
    tracep->declBus(c+339,"axi_r_data_o_r", false,-1, 31,0);
    tracep->popNamePrefix(3);
    ...
    tracep->declBus(c+432,"rd_data", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+397+i*1,"gpr", true,(i+0), 31,0);
    }
    ...
    tracep->declBus(c+115,"exu_result", false,-1, 31,0);
    tracep->declBus(c+116,"lsu_result", false,-1, 31,0);
    tracep->declBus(c+433,"csr_result", false,-1, 31,0);
    tracep->declBit(c+117,"lsu_rd_wen", false,-1);
    tracep->declBit(c+429,"idu_rd_wen", false,-1);
    tracep->declBit(c+118,"wbu_rd_wen", false,-1);
    tracep->declBus(c+432,"wbu_result", false,-1, 31,0);
    tracep->popNamePrefix(2);
}
...
VL_ATTR_COLD void Vysyx_23060077_top___024root__trace_full_sub_0(Vysyx_23060077_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+321,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__lfsr_out),6);
    bufp->fullCData(oldp+322,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__r_delay_cnt),6);
    bufp->fullCData(oldp+323,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__w_delay_cnt),6);
    ...
    bufp->fullCData(oldp+325,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_w_state_nxt),3);
    bufp->fullCData(oldp+326,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_r_state),2);
    bufp->fullCData(oldp+327,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_r_state_nxt),2);
    bufp->fullCData(oldp+328,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__lfsr_out),6);
    bufp->fullCData(oldp+329,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__r_delay_cnt),6);
    bufp->fullCData(oldp+330,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__w_delay_cnt),6);
    bufp->fullCData(oldp+331,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__sram_w_state),3);
    bufp->fullIData(oldp+332,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__w_addr),32);
    bufp->fullIData(oldp+333,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__w_data),32);
    bufp->fullIData(oldp+334,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__w_mask),32);
    bufp->fullCData(oldp+335,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__sram_r_state),2);
    bufp->fullIData(oldp+336,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__r_addr),32);
    bufp->fullIData(oldp+337,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__r_data),32);
    bufp->fullIData(oldp+338,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__raddr),32);
    bufp->fullIData(oldp+339,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_r_data_o_r),32);
    bufp->fullIData(oldp+340,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__mask),32);
    bufp->fullBit(oldp+341,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__ren));
    bufp->fullBit(oldp+342,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__wen));
    bufp->fullBit(oldp+343,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_r_valid_o_r));
    bufp->fullBit(oldp+344,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_b_valid_o_r));
    bufp->fullCData(oldp+345,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT____Vcellinp__riscv_mux_ls_lsu_opt__key),5);
                                             ...
                                             & ((- (IData)(
                                                           (1U 
                                                            & (vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_r_data_o_r 
                                                               >> 7U)))) 
                                                >> 4U)));
    bufp->fullWData(oldp+346,(__Vtemp_hed5adefe__0),185);
    bufp->fullQData(oldp+352,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__pair_list[0]),37);
    bufp->fullQData(oldp+354,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__pair_list[1]),37);
    bufp->fullQData(oldp+356,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__pair_list[2]),37);
    bufp->fullQData(oldp+358,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__pair_list[3]),37);
    bufp->fullQData(oldp+360,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__pair_list[4]),37);
    bufp->fullIData(oldp+362,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__data_list[0]),32);
    bufp->fullIData(oldp+363,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__data_list[1]),32);
    bufp->fullIData(oldp+364,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__data_list[2]),32);
    bufp->fullIData(oldp+365,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__data_list[3]),32);
    bufp->fullIData(oldp+366,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__data_list[4]),32);
    bufp->fullIData(oldp+367,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__lut_out),32);
    bufp->fullBit(oldp+368,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__hit));
    bufp->fullIData(oldp+369,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_wmask__DOT__i1__DOT__lut_out),32);
    bufp->fullBit(oldp+370,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_wmask__DOT__i1__DOT__hit));
    bufp->fullCData(oldp+371,((7U & vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__mask)),3);
    bufp->fullBit(oldp+372,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_aw_ready_o_r));
    bufp->fullBit(oldp+373,((1U == (IData)(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_w_state))));
    bufp->fullBit(oldp+374,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_w_ready_o_r));
    bufp->fullBit(oldp+375,((2U == (IData)(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_w_state))));
    bufp->fullBit(oldp+376,((3U == (IData)(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_w_state))));
    bufp->fullBit(oldp+377,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_ar_ready_o_r));
    bufp->fullBit(oldp+378,((1U == (IData)(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_r_state))));
    bufp->fullBit(oldp+379,((2U == (IData)(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_r_state))));
    bufp->fullCData(oldp+380,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__lfsr_out),6);
    bufp->fullCData(oldp+381,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__r_delay_cnt),6);
    bufp->fullCData(oldp+382,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__w_delay_cnt),6);
    bufp->fullCData(oldp+383,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_w_state),3);
    bufp->fullCData(oldp+384,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_w_state_nxt),3);
    bufp->fullCData(oldp+385,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_r_state),2);
    bufp->fullCData(oldp+386,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_r_state_nxt),2);
    bufp->fullCData(oldp+387,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__lfsr_out),6);
    bufp->fullCData(oldp+388,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__r_delay_cnt),6);
    bufp->fullCData(oldp+389,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__w_delay_cnt),6);
    bufp->fullCData(oldp+390,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__sram_w_state),3);
    bufp->fullIData(oldp+391,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__w_addr),32);
    bufp->fullIData(oldp+392,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__w_data),32);
    bufp->fullIData(oldp+393,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__w_mask),32);
    bufp->fullCData(oldp+394,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__sram_r_state),2);
    bufp->fullIData(oldp+395,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__r_addr),32);
    bufp->fullIData(oldp+396,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__r_data),32);
    bufp->fullIData(oldp+397,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[0]),32);
    bufp->fullIData(oldp+398,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[1]),32);
    bufp->fullIData(oldp+399,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[2]),32);
    bufp->fullIData(oldp+400,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[3]),32);
    bufp->fullIData(oldp+401,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[4]),32);
    bufp->fullIData(oldp+402,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[5]),32);
    bufp->fullIData(oldp+403,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[6]),32);
    bufp->fullIData(oldp+404,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[7]),32);
    bufp->fullIData(oldp+405,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[8]),32);
    bufp->fullIData(oldp+406,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[9]),32);
    bufp->fullIData(oldp+407,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[10]),32);
    bufp->fullIData(oldp+408,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[11]),32);
    bufp->fullIData(oldp+409,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[12]),32);
    bufp->fullIData(oldp+410,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[13]),32);
    bufp->fullIData(oldp+411,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[14]),32);
    bufp->fullIData(oldp+412,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[15]),32);
    bufp->fullIData(oldp+413,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[16]),32);
    bufp->fullIData(oldp+414,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[17]),32);
    bufp->fullIData(oldp+415,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[18]),32);
    bufp->fullIData(oldp+416,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[19]),32);
    bufp->fullIData(oldp+417,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[20]),32);
    bufp->fullIData(oldp+418,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[21]),32);
    bufp->fullIData(oldp+419,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[22]),32);
    bufp->fullIData(oldp+420,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[23]),32);
    bufp->fullIData(oldp+421,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[24]),32);
    bufp->fullIData(oldp+422,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[25]),32);
    bufp->fullIData(oldp+423,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[26]),32);
    bufp->fullIData(oldp+424,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[27]),32);
    bufp->fullIData(oldp+425,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[28]),32);
    bufp->fullIData(oldp+426,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[29]),32);
    bufp->fullIData(oldp+427,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[30]),32);
    bufp->fullIData(oldp+428,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[31]),32);
    bufp->fullBit(oldp+429,(vlSelf->ysyx_23060077_top__DOT____Vcellinp__riscv_wbu_u0__idu_rd_wen));
    bufp->fullBit(oldp+430,(vlSelf->clk));
    bufp->fullBit(oldp+431,(vlSelf->rst_n));
    bufp->fullIData(oldp+432,(((0U == (IData)(vlSelf->ysyx_23060077_top__DOT__idu_lsu_opt))
    ...
    bufp->fullIData(oldp+433,(((IData)(vlSelf->rst_n)
                                ? ((IData)(vlSelf->ysyx_23060077_top__DOT__riscv_csr_u0__DOT__wr_en)
                                   ...
                                   [(0xfffU & vlSelf->ysyx_23060077_top__DOT__riscv_idu_u0__DOT__riscv_id_imm_idu__DOT__imm_r)]
                                    : 0U) : 0U)),32);
    bufp->fullIData(oldp+434,(vlSelf->ysyx_23060077_top__DOT__ifu_inst_t),32);
    bufp->fullIData(oldp+435,(vlSelf->ysyx_23060077_top__DOT__exu_result_t),32);
    bufp->fullBit(oldp+436,(vlSelf->ysyx_23060077_top__DOT__riscv_exu_u0__DOT__carry_flag));
    bufp->fullBit(oldp+437,(vlSelf->ysyx_23060077_top__DOT__riscv_exu_u0__DOT__signed_flag));
    bufp->fullIData(oldp+438,(0xbU),32);
    ...
    bufp->fullBit(oldp+472,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__cpu_w_valid_i));
    bufp->fullIData(oldp+473,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__cpu_w_addr_i),32);
    bufp->fullIData(oldp+474,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__cpu_w_data_i),32);
    bufp->fullCData(oldp+475,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__cpu_w_strb_i),3);
    bufp->fullCData(oldp+476,(0U),3);
    bufp->fullCData(oldp+477,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__axi_b_resp_i),3);
    bufp->fullCData(oldp+478,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__axi_r_resp_i),3);
    bufp->fullCData(oldp+479,(1U),3);
    bufp->fullCData(oldp+480,(2U),3);
    bufp->fullCData(oldp+481,(3U),3);
    bufp->fullCData(oldp+482,(4U),3);
    bufp->fullCData(oldp+483,(2U),2);
    bufp->fullCData(oldp+484,(3U),2);
    ...
    bufp->fullWData(oldp+488,(__Vtemp_heb927861__0),111);
    bufp->fullCData(oldp+492,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__axi_b_resp_i),3);
    bufp->fullCData(oldp+493,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__axi_r_resp_i),3);
}
