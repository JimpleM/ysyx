...
VL_ATTR_COLD void Vysyx_23060077_top___024root__trace_init_sub__TOP__0(Vysyx_23060077_top___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+424,"ifu_inst_t", false,-1, 31,0);
    ...
    tracep->declBus(c+422,"rd_data", false,-1, 31,0);
    tracep->declBit(c+114,"zero_flag", false,-1);
    tracep->declBus(c+115,"exu_result", false,-1, 31,0);
    tracep->declBus(c+425,"exu_result_t", false,-1, 31,0);
    ...
    tracep->declBus(c+423,"rd_csr_data", false,-1, 31,0);
    ...
    tracep->declBus(c+423,"rd_data", false,-1, 31,0);
    ...
    tracep->declBus(c+423,"rd_data_r", false,-1, 31,0);
    ...
    tracep->declArray(c+450,"lut", false,-1, 98,0);
    tracep->pushNamePrefix("i1 ");
    tracep->declBus(c+428,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+448,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+437,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+457,"lut", false,-1, 26,0);
    tracep->pushNamePrefix("i1 ");
    tracep->declBus(c+455,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+448,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+437,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBit(c+420,"aclk", false,-1);
    tracep->declBit(c+421,"areset_n", false,-1);
    tracep->declBit(c+96,"cpu_r_valid_i", false,-1);
    tracep->declBus(c+309,"cpu_r_addr_i", false,-1, 31,0);
    tracep->declBit(c+311,"cpu_r_ready_o", false,-1);
    tracep->declBus(c+310,"cpu_r_data_o", false,-1, 31,0);
    tracep->declBit(c+462,"cpu_w_valid_i", false,-1);
    tracep->declBus(c+463,"cpu_w_addr_i", false,-1, 31,0);
    tracep->declBit(c+312,"cpu_w_ready_o", false,-1);
    tracep->declBus(c+464,"cpu_w_data_i", false,-1, 31,0);
    tracep->declBus(c+465,"cpu_w_strb_i", false,-1, 2,0);
    tracep->declBit(c+313,"axi_aw_ready_i", false,-1);
    tracep->declBit(c+314,"axi_aw_valid_o", false,-1);
    tracep->declBus(c+466,"axi_aw_port_o", false,-1, 2,0);
    tracep->declBus(c+463,"axi_aw_addr_o", false,-1, 31,0);
    tracep->declBit(c+315,"axi_w_ready_i", false,-1);
    tracep->declBit(c+316,"axi_w_valid_o", false,-1);
    tracep->declBus(c+465,"axi_w_strb_o", false,-1, 2,0);
    tracep->declBus(c+464,"axi_w_data_o", false,-1, 31,0);
    tracep->declBus(c+467,"axi_b_resp_i", false,-1, 2,0);
    ...
    tracep->declBus(c+466,"axi_ar_port_o", false,-1, 2,0);
    ...
    tracep->declBus(c+468,"axi_r_resp_i", false,-1, 2,0);
    ...
    tracep->declBus(c+466,"AXI_W_IDLE", false,-1, 2,0);
    tracep->declBus(c+469,"AXI_W_ADDR", false,-1, 2,0);
    tracep->declBus(c+470,"AXI_W_DATA", false,-1, 2,0);
    tracep->declBus(c+471,"AXI_W_RESP", false,-1, 2,0);
    tracep->declBus(c+322,"axi_r_state", false,-1, 1,0);
    tracep->declBus(c+456,"AXI_R_IDLE", false,-1, 1,0);
    tracep->declBus(c+449,"AXI_R_ADDR", false,-1, 1,0);
    tracep->declBus(c+472,"AXI_R_DATA", false,-1, 1,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+466,"axi_aw_port_i", false,-1, 2,0);
    tracep->declBus(c+463,"axi_aw_addr_i", false,-1, 31,0);
    tracep->declBit(c+315,"axi_w_ready_o", false,-1);
    tracep->declBit(c+316,"axi_w_valid_i", false,-1);
    tracep->declBus(c+465,"axi_w_strb_i", false,-1, 2,0);
    tracep->declBus(c+464,"axi_w_data_i", false,-1, 31,0);
    tracep->declBus(c+467,"axi_b_resp_o", false,-1, 2,0);
    ...
    tracep->declBus(c+466,"axi_ar_port_i", false,-1, 2,0);
    ...
    tracep->declBus(c+468,"axi_r_resp_o", false,-1, 2,0);
    tracep->declBus(c+310,"axi_r_data_o", false,-1, 31,0);
    tracep->declBus(c+323,"lfsr_out", false,-1, 5,0);
    tracep->declBus(c+324,"r_delay_cnt", false,-1, 5,0);
    tracep->declBus(c+325,"w_delay_cnt", false,-1, 5,0);
    tracep->declBus(c+326,"sram_w_state", false,-1, 2,0);
    tracep->declBus(c+466,"SRAM_W_IDLE", false,-1, 2,0);
    tracep->declBus(c+469,"SRAM_W_ADDR", false,-1, 2,0);
    tracep->declBus(c+470,"SRAM_W_DATA", false,-1, 2,0);
    tracep->declBus(c+471,"SRAM_W_RESP", false,-1, 2,0);
    ...
    tracep->declBus(c+456,"SRAM_R_IDLE", false,-1, 1,0);
    tracep->declBus(c+449,"SRAM_R_ADDR", false,-1, 1,0);
    tracep->declBus(c+472,"SRAM_R_DATA", false,-1, 1,0);
    ...
    tracep->declBit(c+117,"lsu_rd_wen", false,-1);
    tracep->declBus(c+116,"lsu_result", false,-1, 31,0);
    tracep->declBus(c+333,"raddr", false,-1, 31,0);
    tracep->declBus(c+334,"rdata", false,-1, 31,0);
    tracep->declBus(c+333,"waddr", false,-1, 31,0);
    tracep->declBus(c+113,"wdata", false,-1, 31,0);
    tracep->declBus(c+335,"wmask", false,-1, 31,0);
    tracep->declBus(c+335,"mask", false,-1, 31,0);
    tracep->declBit(c+336,"ren", false,-1);
    tracep->declBit(c+337,"wen", false,-1);
    tracep->declBit(c+338,"lsu_rd_wen_r", false,-1);
    tracep->declBit(c+339,"lsu_rd_wen_w", false,-1);
    ...
    tracep->declBus(c+340,"key", false,-1, 4,0);
    tracep->declBus(c+431,"default_out", false,-1, 31,0);
    tracep->declArray(c+341,"lut", false,-1, 184,0);
    tracep->pushNamePrefix("i1 ");
    tracep->declBus(c+473,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+473,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+430,"DATA_LEN", false,-1, 31,0);
    ...
    for (int i = 0; i < 5; ++i) {
        tracep->declQuad(c+347+i*2,"pair_list", true,(i+0), 36,0);
    }
    for (int i = 0; i < 5; ++i) {
    ...
    tracep->declBus(c+473,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+430,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+335,"out", false,-1, 31,0);
    tracep->declBus(c+340,"key", false,-1, 4,0);
    tracep->declBus(c+431,"default_out", false,-1, 31,0);
    ...
    tracep->declBit(c+420,"aclk", false,-1);
    tracep->declBit(c+421,"areset_n", false,-1);
    tracep->declBit(c+336,"cpu_r_valid_i", false,-1);
    tracep->declBus(c+333,"cpu_r_addr_i", false,-1, 31,0);
    tracep->declBit(c+338,"cpu_r_ready_o", false,-1);
    tracep->declBus(c+334,"cpu_r_data_o", false,-1, 31,0);
    tracep->declBit(c+337,"cpu_w_valid_i", false,-1);
    tracep->declBus(c+333,"cpu_w_addr_i", false,-1, 31,0);
    tracep->declBit(c+339,"cpu_w_ready_o", false,-1);
    tracep->declBus(c+113,"cpu_w_data_i", false,-1, 31,0);
    tracep->declBus(c+366,"cpu_w_strb_i", false,-1, 2,0);
    tracep->declBit(c+367,"axi_aw_ready_i", false,-1);
    tracep->declBit(c+368,"axi_aw_valid_o", false,-1);
    tracep->declBus(c+466,"axi_aw_port_o", false,-1, 2,0);
    tracep->declBus(c+333,"axi_aw_addr_o", false,-1, 31,0);
    tracep->declBit(c+369,"axi_w_ready_i", false,-1);
    tracep->declBit(c+370,"axi_w_valid_o", false,-1);
    tracep->declBus(c+366,"axi_w_strb_o", false,-1, 2,0);
    tracep->declBus(c+113,"axi_w_data_o", false,-1, 31,0);
    tracep->declBus(c+480,"axi_b_resp_i", false,-1, 2,0);
    tracep->declBit(c+339,"axi_b_valid_i", false,-1);
    tracep->declBit(c+371,"axi_b_ready_o", false,-1);
    tracep->declBit(c+372,"axi_ar_ready_i", false,-1);
    tracep->declBit(c+373,"axi_ar_valid_o", false,-1);
    tracep->declBus(c+466,"axi_ar_port_o", false,-1, 2,0);
    tracep->declBus(c+333,"axi_ar_addr_o", false,-1, 31,0);
    tracep->declBit(c+374,"axi_r_ready_o", false,-1);
    tracep->declBit(c+338,"axi_r_valid_i", false,-1);
    tracep->declBus(c+481,"axi_r_resp_i", false,-1, 2,0);
    tracep->declBus(c+334,"axi_r_data_i", false,-1, 31,0);
    tracep->pushNamePrefix("u_ysyx_23060077_riscv_axi ");
    tracep->declBit(c+420,"aclk", false,-1);
    tracep->declBit(c+421,"areset_n", false,-1);
    tracep->declBit(c+336,"cpu_r_valid_i", false,-1);
    ...
    tracep->declBus(c+481,"axi_r_resp_i", false,-1, 2,0);
    tracep->declBus(c+334,"axi_r_data_i", false,-1, 31,0);
    tracep->declBus(c+375,"axi_w_state", false,-1, 2,0);
    tracep->declBus(c+466,"AXI_W_IDLE", false,-1, 2,0);
    tracep->declBus(c+469,"AXI_W_ADDR", false,-1, 2,0);
    tracep->declBus(c+470,"AXI_W_DATA", false,-1, 2,0);
    tracep->declBus(c+471,"AXI_W_RESP", false,-1, 2,0);
    tracep->declBus(c+376,"axi_r_state", false,-1, 1,0);
    tracep->declBus(c+456,"AXI_R_IDLE", false,-1, 1,0);
    tracep->declBus(c+449,"AXI_R_ADDR", false,-1, 1,0);
    tracep->declBus(c+472,"AXI_R_DATA", false,-1, 1,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+420,"aclk", false,-1);
    tracep->declBit(c+421,"areset_n", false,-1);
    tracep->declBit(c+367,"axi_aw_ready_o", false,-1);
    tracep->declBit(c+368,"axi_aw_valid_i", false,-1);
    tracep->declBus(c+466,"axi_aw_port_i", false,-1, 2,0);
    tracep->declBus(c+333,"axi_aw_addr_i", false,-1, 31,0);
    tracep->declBit(c+369,"axi_w_ready_o", false,-1);
    tracep->declBit(c+370,"axi_w_valid_i", false,-1);
    tracep->declBus(c+366,"axi_w_strb_i", false,-1, 2,0);
    tracep->declBus(c+113,"axi_w_data_i", false,-1, 31,0);
    tracep->declBus(c+480,"axi_b_resp_o", false,-1, 2,0);
    tracep->declBit(c+339,"axi_b_valid_o", false,-1);
    tracep->declBit(c+371,"axi_b_ready_i", false,-1);
    tracep->declBit(c+372,"axi_ar_ready_o", false,-1);
    tracep->declBit(c+373,"axi_ar_valid_i", false,-1);
    tracep->declBus(c+466,"axi_ar_port_i", false,-1, 2,0);
    tracep->declBus(c+333,"axi_ar_addr_i", false,-1, 31,0);
    tracep->declBit(c+374,"axi_r_ready_i", false,-1);
    tracep->declBit(c+338,"axi_r_valid_o", false,-1);
    tracep->declBus(c+481,"axi_r_resp_o", false,-1, 2,0);
    tracep->declBus(c+334,"axi_r_data_o", false,-1, 31,0);
    tracep->declBus(c+377,"lfsr_out", false,-1, 5,0);
    tracep->declBus(c+378,"r_delay_cnt", false,-1, 5,0);
    tracep->declBus(c+379,"w_delay_cnt", false,-1, 5,0);
    tracep->declBus(c+380,"sram_w_state", false,-1, 2,0);
    tracep->declBus(c+466,"SRAM_W_IDLE", false,-1, 2,0);
    tracep->declBus(c+469,"SRAM_W_ADDR", false,-1, 2,0);
    tracep->declBus(c+470,"SRAM_W_DATA", false,-1, 2,0);
    tracep->declBus(c+471,"SRAM_W_RESP", false,-1, 2,0);
    tracep->declBus(c+381,"w_addr", false,-1, 31,0);
    tracep->declBus(c+382,"w_data", false,-1, 31,0);
    tracep->declBus(c+383,"w_mask", false,-1, 31,0);
    tracep->declBit(c+367,"axi_aw_ready_o_r", false,-1);
    tracep->declBit(c+369,"axi_w_ready_o_r", false,-1);
    tracep->declBit(c+339,"axi_b_valid_o_r", false,-1);
    tracep->declBus(c+384,"sram_r_state", false,-1, 1,0);
    tracep->declBus(c+456,"SRAM_R_IDLE", false,-1, 1,0);
    tracep->declBus(c+449,"SRAM_R_ADDR", false,-1, 1,0);
    tracep->declBus(c+472,"SRAM_R_DATA", false,-1, 1,0);
    tracep->declBus(c+385,"r_addr", false,-1, 31,0);
    tracep->declBus(c+386,"r_data", false,-1, 31,0);
    tracep->declBit(c+372,"axi_ar_ready_o_r", false,-1);
    tracep->declBit(c+338,"axi_r_valid_o_r", false,-1);
    tracep->declBus(c+334,"axi_r_data_o_r", false,-1, 31,0);
    tracep->popNamePrefix(3);
    ...
    tracep->declBus(c+115,"exu_result", false,-1, 31,0);
    tracep->declBus(c+116,"lsu_result", false,-1, 31,0);
    tracep->declBus(c+423,"csr_result", false,-1, 31,0);
    tracep->declBit(c+117,"lsu_rd_wen", false,-1);
    tracep->declBit(c+419,"idu_rd_wen", false,-1);
    tracep->declBit(c+118,"wbu_rd_wen", false,-1);
    tracep->declBus(c+422,"wbu_result", false,-1, 31,0);
    tracep->popNamePrefix(2);
}
...
VL_ATTR_COLD void Vysyx_23060077_top___024root__trace_full_sub_0(Vysyx_23060077_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+323,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__lfsr_out),6);
    bufp->fullCData(oldp+324,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__r_delay_cnt),6);
    bufp->fullCData(oldp+325,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__w_delay_cnt),6);
    ...
    bufp->fullIData(oldp+333,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__raddr),32);
    bufp->fullIData(oldp+334,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_r_data_o_r),32);
    bufp->fullIData(oldp+335,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__mask),32);
    bufp->fullBit(oldp+336,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__ren));
    bufp->fullBit(oldp+337,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__wen));
    bufp->fullBit(oldp+338,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_r_valid_o_r));
    bufp->fullBit(oldp+339,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_b_valid_o_r));
    bufp->fullCData(oldp+340,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT____Vcellinp__riscv_mux_ls_lsu_opt__key),5);
                                             ...
                                             & ((- (IData)(
                                                           (1U 
                                                            & (vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_r_data_o_r 
                                                               >> 7U)))) 
                                                >> 4U)));
    bufp->fullWData(oldp+341,(__Vtemp_hed5adefe__0),185);
    bufp->fullQData(oldp+347,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__pair_list[0]),37);
    bufp->fullQData(oldp+349,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__pair_list[1]),37);
    bufp->fullQData(oldp+351,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__pair_list[2]),37);
    bufp->fullQData(oldp+353,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__pair_list[3]),37);
    bufp->fullQData(oldp+355,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__pair_list[4]),37);
    bufp->fullIData(oldp+357,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__data_list[0]),32);
    bufp->fullIData(oldp+358,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__data_list[1]),32);
    bufp->fullIData(oldp+359,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__data_list[2]),32);
    bufp->fullIData(oldp+360,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__data_list[3]),32);
    bufp->fullIData(oldp+361,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__data_list[4]),32);
    bufp->fullIData(oldp+362,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__lut_out),32);
    bufp->fullBit(oldp+363,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_lsu_opt__DOT__i1__DOT__hit));
    bufp->fullIData(oldp+364,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_wmask__DOT__i1__DOT__lut_out),32);
    bufp->fullBit(oldp+365,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__riscv_mux_ls_wmask__DOT__i1__DOT__hit));
    bufp->fullCData(oldp+366,((7U & vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__mask)),3);
    bufp->fullBit(oldp+367,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_aw_ready_o_r));
    bufp->fullBit(oldp+368,((1U == (IData)(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_w_state))));
    bufp->fullBit(oldp+369,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_w_ready_o_r));
    bufp->fullBit(oldp+370,((2U == (IData)(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_w_state))));
    bufp->fullBit(oldp+371,((3U == (IData)(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_w_state))));
    bufp->fullBit(oldp+372,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__axi_ar_ready_o_r));
    bufp->fullBit(oldp+373,((1U == (IData)(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_r_state))));
    bufp->fullBit(oldp+374,((2U == (IData)(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_r_state))));
    bufp->fullCData(oldp+375,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_w_state),3);
    bufp->fullCData(oldp+376,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi__DOT__axi_r_state),2);
    bufp->fullCData(oldp+377,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__lfsr_out),6);
    bufp->fullCData(oldp+378,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__r_delay_cnt),6);
    bufp->fullCData(oldp+379,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__w_delay_cnt),6);
    bufp->fullCData(oldp+380,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__sram_w_state),3);
    bufp->fullIData(oldp+381,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__w_addr),32);
    bufp->fullIData(oldp+382,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__w_data),32);
    bufp->fullIData(oldp+383,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__w_mask),32);
    bufp->fullCData(oldp+384,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__sram_r_state),2);
    bufp->fullIData(oldp+385,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__r_addr),32);
    bufp->fullIData(oldp+386,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__u_ysyx_23060077_riscv_axi_sram__DOT__r_data),32);
    bufp->fullIData(oldp+387,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[0]),32);
    bufp->fullIData(oldp+388,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[1]),32);
    bufp->fullIData(oldp+389,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[2]),32);
    bufp->fullIData(oldp+390,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[3]),32);
    bufp->fullIData(oldp+391,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[4]),32);
    bufp->fullIData(oldp+392,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[5]),32);
    bufp->fullIData(oldp+393,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[6]),32);
    bufp->fullIData(oldp+394,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[7]),32);
    bufp->fullIData(oldp+395,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[8]),32);
    bufp->fullIData(oldp+396,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[9]),32);
    bufp->fullIData(oldp+397,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[10]),32);
    bufp->fullIData(oldp+398,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[11]),32);
    bufp->fullIData(oldp+399,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[12]),32);
    bufp->fullIData(oldp+400,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[13]),32);
    bufp->fullIData(oldp+401,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[14]),32);
    bufp->fullIData(oldp+402,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[15]),32);
    bufp->fullIData(oldp+403,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[16]),32);
    bufp->fullIData(oldp+404,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[17]),32);
    bufp->fullIData(oldp+405,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[18]),32);
    bufp->fullIData(oldp+406,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[19]),32);
    bufp->fullIData(oldp+407,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[20]),32);
    bufp->fullIData(oldp+408,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[21]),32);
    bufp->fullIData(oldp+409,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[22]),32);
    bufp->fullIData(oldp+410,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[23]),32);
    bufp->fullIData(oldp+411,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[24]),32);
    bufp->fullIData(oldp+412,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[25]),32);
    bufp->fullIData(oldp+413,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[26]),32);
    bufp->fullIData(oldp+414,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[27]),32);
    bufp->fullIData(oldp+415,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[28]),32);
    bufp->fullIData(oldp+416,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[29]),32);
    bufp->fullIData(oldp+417,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[30]),32);
    bufp->fullIData(oldp+418,(vlSelf->ysyx_23060077_top__DOT__riscv_regfile_u0__DOT__gpr[31]),32);
    bufp->fullBit(oldp+419,(vlSelf->ysyx_23060077_top__DOT____Vcellinp__riscv_wbu_u0__idu_rd_wen));
    bufp->fullBit(oldp+420,(vlSelf->clk));
    bufp->fullBit(oldp+421,(vlSelf->rst_n));
    bufp->fullIData(oldp+422,(((0U == (IData)(vlSelf->ysyx_23060077_top__DOT__idu_lsu_opt))
    ...
    bufp->fullIData(oldp+423,(((IData)(vlSelf->rst_n)
                                ? ((IData)(vlSelf->ysyx_23060077_top__DOT__riscv_csr_u0__DOT__wr_en)
                                    ? vlSelf->ysyx_23060077_top__DOT__riscv_csr_u0__DOT__csr_reg
                                   [(0xfffU & vlSelf->ysyx_23060077_top__DOT__riscv_idu_u0__DOT__riscv_id_imm_idu__DOT__imm_r)]
                                    : 0U) : 0U)),32);
    bufp->fullIData(oldp+424,(vlSelf->ysyx_23060077_top__DOT__ifu_inst_t),32);
    bufp->fullIData(oldp+425,(vlSelf->ysyx_23060077_top__DOT__exu_result_t),32);
    bufp->fullBit(oldp+426,(vlSelf->ysyx_23060077_top__DOT__riscv_exu_u0__DOT__carry_flag));
    bufp->fullBit(oldp+427,(vlSelf->ysyx_23060077_top__DOT__riscv_exu_u0__DOT__signed_flag));
    ...
    bufp->fullWData(oldp+450,(__Vtemp_h8c90ec6d__0),99);
    bufp->fullIData(oldp+454,(9U),32);
    bufp->fullIData(oldp+455,(3U),32);
    bufp->fullCData(oldp+456,(0U),2);
    bufp->fullIData(oldp+457,(0x351dcfU),27);
    ...
    bufp->fullBit(oldp+462,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__cpu_w_valid_i));
    bufp->fullIData(oldp+463,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__cpu_w_addr_i),32);
    bufp->fullIData(oldp+464,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__cpu_w_data_i),32);
    bufp->fullCData(oldp+465,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__cpu_w_strb_i),3);
    bufp->fullCData(oldp+466,(0U),3);
    bufp->fullCData(oldp+467,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__axi_b_resp_i),3);
    bufp->fullCData(oldp+468,(vlSelf->ysyx_23060077_top__DOT__riscv_ifu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__axi_r_resp_i),3);
    bufp->fullCData(oldp+469,(1U),3);
    bufp->fullCData(oldp+470,(2U),3);
    bufp->fullCData(oldp+471,(3U),3);
    ...
    bufp->fullCData(oldp+480,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__axi_b_resp_i),3);
    bufp->fullCData(oldp+481,(vlSelf->ysyx_23060077_top__DOT__riscv_lsu_u0__DOT__u_ysyx_23060077_riscv_axi_lite__DOT__axi_r_resp_i),3);
}
