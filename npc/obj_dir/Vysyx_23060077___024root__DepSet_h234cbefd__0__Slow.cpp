...
#endif
                VL_FATAL_MT("/home/jimple/Documents/ysyx/ysyx-workbench/npc/vsrc/ysyx_23060077.v", 4, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vysyx_23060077___024root___ctor_var_reset(Vysyx_23060077___024root* vlSelf) {
    ...
    vlSelf->io_master_awrea = VL_RAND_RESET_I(1);
    vlSelf->io_master_awval = VL_RAND_RESET_I(1);
    vlSelf->io_master_awadd = VL_RAND_RESET_I(32);
    vlSelf->io_master_awid = VL_RAND_RESET_I(4);
    vlSelf->io_master_awlen = VL_RAND_RESET_I(8);
    vlSelf->io_master_awsiz = VL_RAND_RESET_I(3);
    vlSelf->io_master_awbur = VL_RAND_RESET_I(2);
    vlSelf->io_master_wread = VL_RAND_RESET_I(1);
    vlSelf->io_master_wvali = VL_RAND_RESET_I(1);
    ...
    vlSelf->io_master_bread = VL_RAND_RESET_I(1);
    vlSelf->io_master_bvali = VL_RAND_RESET_I(1);
    vlSelf->io_master_bresp = VL_RAND_RESET_I(2);
    vlSelf->io_master_bid = VL_RAND_RESET_I(4);
    vlSelf->io_master_arrea = VL_RAND_RESET_I(1);
    vlSelf->io_master_arval = VL_RAND_RESET_I(1);
    vlSelf->io_master_aradd = VL_RAND_RESET_I(32);
    vlSelf->io_master_arid = VL_RAND_RESET_I(4);
    vlSelf->io_master_arlen = VL_RAND_RESET_I(8);
    vlSelf->io_master_arsiz = VL_RAND_RESET_I(3);
    vlSelf->io_master_arbur = VL_RAND_RESET_I(2);
    vlSelf->io_master_rread = VL_RAND_RESET_I(1);
    vlSelf->io_master_rvali = VL_RAND_RESET_I(1);
    ...
    vlSelf->io_slave_wdata = VL_RAND_RESET_Q(64);
    vlSelf->io_slave_wstrb = VL_RAND_RESET_I(8);
    ...
    vlSelf->io_slave_rdata = VL_RAND_RESET_Q(64);
